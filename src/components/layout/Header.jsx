...
function Header({ onMenuClick }) {
  ...
  const showThemeControls = location.pathname === '/calendario-canvas-light'
    ...
    <header className={styles.header}>
      ...
      {showThemeControls && (
        <div className={styles.right}>
          {/* Contrast selector - PRIMA */}
          <div className={styles.contrastSelector}>
            <button
              className={`${styles.contrastBtn} ${contrast === 'standard' ? styles.active : ''}`}
            ...
            <button
              className={`${styles.contrastBtn} ${contrast === 'medium' ? styles.active : ''}`}
            ...
            <button
              className={`${styles.contrastBtn} ${contrast === 'high' ? styles.active : ''}`}
